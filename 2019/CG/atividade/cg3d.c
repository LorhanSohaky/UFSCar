...
point3d *VectorProduct3d( point3d *u, point3d *v ) {
	...
	/*
	 i  j  k
	 u1 u2 u3       u2v3i + u3v1j + u1v2k - u2v1k - u3v2i - u1v3j = (u2v3 - u3v2)i + (u3v1 - u1v3)j
	 + (u1v2 - u2v1)k v1 v2 v3
	 */
...
object3d *ConvertObjectBase( point3d *w, point3d *vu, point3d *ov, object3d *ob ) {
	...
	for( numbers_of_faces = 0; numbers_of_faces < ob->numbers_of_faces; numbers_of_faces++ ) {
		mob->faces[numbers_of_faces].numbers_of_points =
			ob->faces[numbers_of_faces].numbers_of_points;
		mob->faces[numbers_of_faces].points =
			(point3d *)malloc( ob->faces[numbers_of_faces].numbers_of_points * sizeof( point3d ) );
		for( numbers_of_points = 0;
			 numbers_of_points < ob->faces[numbers_of_faces].numbers_of_points;
			 numbers_of_points++ ) {
...
object *ParalProjFaces( object3d *ob3d ) {
	...
	for( numbers_of_faces = 0; numbers_of_faces < ob3d->numbers_of_faces; numbers_of_faces++ ) {
		facelist[numbers_of_faces].numbers_of_points =
			ob3d->faces[numbers_of_faces].numbers_of_points;
		facelist[numbers_of_faces].points =
			(point *)malloc( facelist[numbers_of_faces].numbers_of_points * sizeof( point ) );
		for( numbers_of_points = 0;
			 numbers_of_points < ob3d->faces[numbers_of_faces].numbers_of_points;
			 numbers_of_points++ ) {
			facelist[numbers_of_faces].points[numbers_of_points].x =
				ob3d->faces[numbers_of_faces].points[numbers_of_points].x;
			facelist[numbers_of_faces].points[numbers_of_points].y =
				ob3d->faces[numbers_of_faces].points[numbers_of_points].y;
			facelist[numbers_of_faces].points[numbers_of_points].w = 1;
			facelist[numbers_of_faces].points[numbers_of_points].color =
				ob3d->faces[numbers_of_faces].points[numbers_of_points].color;
		}
	}
...
object *PerspProjFaces( object3d *ob3d, float zpp, float zcp ) {
	...
	for( numbers_of_faces = 0; numbers_of_faces < ob3d->numbers_of_faces; numbers_of_faces++ ) {
		...
		for( numbers_of_points = 0;
			 ...
			 numbers_of_points++ ) {
			facelist[numbers_of_faces].points[numbers_of_points].x =
				( ( ob3d->faces[numbers_of_faces].points[numbers_of_points].x ) * ( zpp - zcp ) ) /
				( ob3d->faces[numbers_of_faces].points[numbers_of_points].z - zcp );
			facelist[numbers_of_faces].points[numbers_of_points].y =
				( ( ob3d->faces[numbers_of_faces].points[numbers_of_points].y ) * ( zpp - zcp ) ) /
				( ob3d->faces[numbers_of_faces].points[numbers_of_points].z - zcp );
			facelist[numbers_of_faces].points[numbers_of_points].w = 1;
			facelist[numbers_of_faces].points[numbers_of_points].color =
				ob3d->faces[numbers_of_faces].points[numbers_of_points].color;
