...
% ---
\titulo{Experimento 01 - Aprendendo a utilizar o programa Quartus}
...
\preambulo{Relatório Modelo canônico de trabalho monográfico acadêmico em conformidade com
...
\orientador{Fredy João Valentes}
...
\input{resumo}
\input{descricao-execucao-experimental}
\input{avaliacao-dos-resultados}
\input{analise-critica-discussao}
\input{outras-informacoes}
