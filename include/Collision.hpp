...
namespace Collision {
    ...
    /// with alpha value 128 will cause a collision and a pixel with alpha value 126 will not.
    ///
    ...
    //////
    /// Test for a collision between sprite and Vector by comparing the alpha value at Vector
    /// position
    /// This functions creates bitmasks of the texture of the sprite by
    /// downloading the texture from the graphics card to memory -> SLOW!
    /// You can avoid this by using the "CreateTextureAndBitmask" function
    //////
